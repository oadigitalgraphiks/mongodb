        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-dark">{{translate("Country Edit")}}</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div id="kt_content_container" class="container-xxl ">
            <form class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10"
                action="{{ route('admin.countries.update', $country->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            <div class="mb-5 fv-row">
                                ...
                                <input type="text" placeholder="{{ translate('Name') }}" id="name" name="name" class="form-control mb-2" value="{{ $country->name }}" required>
                                <div class="text-muted fs-7">{{translate('A Country name is required and recommended to be unique')}}.
                                </div>
                            </div>
                            <div class="mb-5 fv-row">
                                <label class="required form-label">{{ translate('Country Code') }}</label>
                                <input type="text" placeholder="{{ translate('Code') }}" id="code" name="code" class="form-control mb-2" value="{{ $country->code }}" required>
                                <div class="text-muted fs-7">{{translate('A Country code is required and recommended to be unique')}}.
                                </div>
                            </div>
                        </div>
                    </div>
