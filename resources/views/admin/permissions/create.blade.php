    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{translate('Permission')}}</h1>
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> <a class="text-muted text-hover-primary"  href="{{route('admin.permissions.index')}}"> {{translate('Permission')}}</a></li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <input type="text" class="form-control mb-2" placeholder="{{translate('Slug')}}"  name="slug" required  />
                                    </div>

                                    <div class="mb-10">
                                        <label class="required form-label">{{translate('Group Name')}}</label>
                                        <input type="text" class="form-control mb-2" placeholder="{{translate('Group Name')}}"  name="group_name" required  />
                                    </div>
