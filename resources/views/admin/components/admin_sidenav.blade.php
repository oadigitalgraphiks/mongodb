...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        <a href="admin.dashboard">
            <img class="mw-100 h-35px logo" src="{{ uploaded_asset(get_setting('system_logo_white')) }}"
                alt="site_name">
        </a>
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item ">
                    <a class="menu-link {{ areActiveRoutes(['admin.dashboard', 'admin.dashboard'])}}"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{subareActiveRoutes(['admin.brands.index','admin.brands.create','admin.brands.edit','admin.products.index','admin.products.edit'])}}">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link {{Request::segment(2) == " products" ? "active" : "" }}"
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{areActiveRoutes(['admin.brands.index','admin.brands.create','admin.brands.edit'])}}"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ subareActiveRoutes(['admin.customers.index', 'admin.customers.index'])}}">
                    <a class="menu-link " href="javascript:void(0)">
                        <span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link {{ areActiveRoutes(['admin.customers.index', 'admin.customers.edit'])}}"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ subareActiveRoutes(['admin.flash_deals.index'])}}">

                    <a class="menu-link {{ areActiveRoutes(['admin.flash_deals.index', 'admin.flash_deals.index'])}}"
                        href="javascript:void(0)">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-primary svg-icon-2x"><svg aria-hidden="true"
                                    focusable="false" data-prefix="fas" data-icon="bullhorn"
                                    class="svg-inline--fa fa-bullhorn fa-w-18" role="img"
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link {{ areActiveRoutes(['admin.flash_deals.index', 'admin.flash_deals.index'])}}"
                                href="{{route('admin.flash_deals.index')}}">
                                <span class="menu-icon">
                ...
                <div class="menu-item ">
                    <a class="menu-link {{ areActiveRoutes(['uploaded-files.index', 'uploaded-files.index'])}}"
                        ...
                        <span class="menu-title">{{translate("Uploads")}}</span></a>
                    <div class="menu-sub menu-sub-accordion menu-active-bg"></div>
                </div>
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link {{ areActiveRoutes(['admin.general_setting.index'])}}" href="{{route("admin.general_setting.index")}}">
                                ...
                                <span class="menu-title">{{translate("Genral Setting")}}</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link {{ areActiveRoutes(['admin.countries.index','admin.countries.create','admin.countries.edit'])}}" href="{{route("admin.countries.index")}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
