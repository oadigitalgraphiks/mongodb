    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ translate('Create Category')}}</h1>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <input readonly type="text" class="slug form-control mb-2" placeholder="{{translate('Slug')}}"  name="slug" required  />
                                        @if($errors->has('slug'))
                                    ...
                                    <div class="mt-3 mb-10">
                                        ...
                                        <select data-control="select2" name="active" class="form-select form-control">
                                            ...
                                            <option value="0">{{ translate('Not Active')}} </option>
                                        </select>
                                    </div>
