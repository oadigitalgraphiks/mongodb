    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ translate('Edit Product') }} </h1>
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> <a class="text-muted" href="{{route('admin.products.index')}}" >{{translate('products')}}</a> </li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-6">
                                                    ...
                                                    <tr class="variant">
                                                        ...
                                                        <td>
                                                            <div class="input-group" data-toggle="aizuploader" data-type="image" >
                                                                ...
                                                                <input type="hidden" name="combinations[{{$key}}][img]" class="selected-files" value="{{$comb->img}}"/>
                                                            </div>
                   ...
                   {{-- Variations --}}
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        <textarea name="description" class="aiz-text-editor" >{{$product->description}}</textarea>
                                    </div>
                                </div>
                                {{-- Description --}}
