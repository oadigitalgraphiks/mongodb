        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{translate('All Taxes')}}</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item"><span class="bullet bg-gray-300 w-5px h-2px"></span></li>
                        <li class="breadcrumb-item text-muted"><a class="text-muted text-hover-primary" href="{{route('admin.taxes.index')}}">{{translate('taxes')}}</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="card card-flush">
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                ...
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    ...
                                    <a href="{{route('admin.taxes.create')}}" class="btn btn-primary">{{translate('Add New')}}</a>
                                </div>
                            </div>
                                        ...
                                        @foreach ($data as $key => $item)
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a href="{{ route('admin.taxes.edit',$item->id)}}" class="btn btn-icon btn-bg-light px-3"><i class="fa-lg text-primary fas fa-edit" ></i></a>

                                                    <a data-href="{{ route('admin.taxes.destroy',$item->id)}}" class="confirm-delete btn btn-icon btn-bg-light px-3">
