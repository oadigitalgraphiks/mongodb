        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{translate('Taxes')}}</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted"><a class="text-muted text-hover-primary" href="{{route('admin.taxes.index')}}">{{translate('Tax')}}</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        @foreach ($data as $key => $item)
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="{{ route('admin.taxes.edit',$item->id)}}" class="menu-link px-3"><i class="fa-lg text-primary fas fa-edit" ></i></a>

                                                    <a data-href="{{ route('admin.taxes.destroy',$item->id)}}" class="confirm-delete bg-white border-0 menu-link px-3">
