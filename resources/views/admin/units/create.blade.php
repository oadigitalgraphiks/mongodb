        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10"
                    action="{{ route('admin.flash_deals.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Main column-->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".js-data-example-ajax").select2({
                ajax: {
                    url: "{{ route('admin.flash_deal.search') }}",
                    dataType: 'json',
                    delay: 250,
            ...
            $('#products').on('change', function() {
                ...
                if (product_ids.length > 0) {
                    $.post('{{ route('admin.flash_deals.product_discount') }}', {
                        _token: '{{ csrf_token() }}',
