        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{translate('Attribute Types')}}</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted"><a class="text-muted text-hover-primary" href="{{route('admin.attribute_types.index')}}">{{translate('Attribute Types')}}</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="card card-flush">
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                ...
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    <a href="{{route('admin.attribute_types.create')}}" class="btn btn-primary">{{translate('Add New')}}</a>
                                </div>
                            </div>
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        @foreach ($data as $key => $item)
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="{{ route('admin.attribute_types.edit',$item->id)}}" class="menu-link px-3"><i class="fa-lg text-primary fas fa-edit" ></i></a>
                                                    <a href="{{ route('admin.attributes.index')}}?type={{$item->id}}" class="menu-link px-3"><i class="fa-lg text-primary fas fa-edit" ></i></a>
                                                   

                                                    <a data-href="{{ route('admin.attribute_types.destroy',$item->id)}}" class="confirm-delete bg-white border-0 menu-link px-3">
