        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
                  <a class="text-muted" href="{{route('admin.attribute_types.index')}}">{{translate('Attribute Types')}}</a></h1>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs nav-fill border-light">
                        @foreach (languages() as $key => $language)
                            <li class="nav-item">
                                <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3" href="{{ route('admin.attribute_types.edit',$data->id).'?lang='.$language->code }}">
                ...
                <form action="{{ route('admin.attribute_types.update', $data->id)}}" method="POST" > 
                    @csrf
                            ...
                            <div class="card card-flush py-4">
                                <div class="card-header">
                                    <div class="card-title">
                                        <h2>{{translate('Attribute Types')}}</h2>
                                    </div>
                                </div>
