    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{translate("All Staff")}}
                </h1>
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{ translate('Staff') }}</li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                <thead>
                                    <tr class="text-center text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-center ">{{ translate('Email Address') }}</th>
                                        ...
                                        @if ($user != null)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @if ($user->status != 1)
                                                        <a class="px-1" href="{{route('admin.staff.status',$user->id)}}" data-toggle="tooltip" title="{{ translate('Ban')}}"><i class="text-danger fa-lg fas fa-lock"></i></a>
                                                    @else
                                                        
                                                    <a class="px-1" data-toggle="tooltip" title="{{ translate('Unban') }}" href="{{route('admin.staff.status',$user->id)}}" >
                                                        <i class="text-success fas fa-lock-open" ></i>
                                                    </a>

                                                    @endif
                                                    
                                                  <a data-toggle="tooltip" title="{{ translate('Login As Staff')}}" href="{{route('admin.staff.login', encrypt($user->id))}}" class="px-1"> <i class=" text-warning fa-lg fas fa-power-off" ></i></a>

                                                  <a data-toggle="tooltip" title="{{ translate('Edit Staff') }}" href="{{route('admin.staff.edit',$user->id)}}" class=""><i class="px-1 fa-lg text-primary fas fa-edit"></i></a>

                                                  <a data-toggle="tooltip" title="{{ translate('Delete Staff') }}"  data-href="{{route("admin.staff.delete",$user)}}"  class="px-1 confirm-delete"><i class="text-danger fa-lg far fa-trash-alt"></i></a>   
                                                     ...
                                                     <div class="modal-dialog">
                                                              <div class="modal-content" id="profile-modal-content">
                                                                <div class="modal-body">
                                                                  @include('admin.staff.modal', ['user' => $user])
                                                                </div>                                          
                                                            </div>
                                                     </div>
                                                  </div>
