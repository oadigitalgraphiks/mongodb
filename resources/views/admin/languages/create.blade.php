    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{translate("Languages Create")}}</h1>
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-dark">{{translate("Language Create")}}</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="card card-flush">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('admin.languages.store') }}" method="POST"
                        ...
                        <div class="row mb-2">
                            <div class="col-xl-3">
                                <label for="required kt_ecommerce_add_product_store_template" class="form-label">{{ translate('Name') }}</label>
                            </div>
                            <div class="col-xl-9">
                        ...
                        <div class="row mb-2">
                            <div class="col-xl-3">
                                <label for="required kt_ecommerce_add_product_store_template" class="form-label">{{ translate('Code') }}</label>
                            </div>
                            <div class="col-xl-9">
                                @php
